...
public class TKTongQuan_Repos implements ITKTongQuan_Repos {
    ...
    public TKTongQuan_Model tkHomNay() {
        ...
        String sql = "	SELECT (\n"
                ...
                + "	FROM HoaDon\n"
                + "	WHERE CONVERT(DATE, HoaDon.NgayThanhToan)  <= getdate() AND HoaDon.TrangThai != 2) AS 'Đơn hàng', \n"
                ...
                + "    WHERE CONVERT(DATE, HoaDon.NgayThanhToan)  <= getdate() AND HoaDon.TrangThai != 2";
