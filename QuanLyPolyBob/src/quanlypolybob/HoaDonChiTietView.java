...
public class HoaDonChiTietView extends javax.swing.JFrame {
    ...
    public HoaDonChiTietView(String maHD) {
        initComponents();
        this.ma = maHD;
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        this.fillTable(service.getAllCTHD(ma));
    }
    ...
    private void fillTable(List<HoaDonCT1> list) {
        mol =(DefaultTableModel) tbl_hoaDonCT.getModel(); 
        mol.setRowCount(0);
        for (HoaDonCT1 hoaDonCT1 : service.getAllCTHD(ma)) {
